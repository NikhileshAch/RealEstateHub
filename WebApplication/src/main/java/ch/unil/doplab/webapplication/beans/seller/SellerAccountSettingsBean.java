package ch.unil.doplab.webapplication.beans.seller;
...
/**
 * Managed bean for seller account settings and deletion.
 */
@Named("sellerAccountSettings")
@RequestScoped
public class SellerAccountSettingsBean implements Serializable {
    ...
    /**
     * Delete the current seller's account.
     * This will cascade delete all properties and offers.
     */
    public String deleteAccount() {
        try {
            ...
            WebTarget target = client.target(SELLERS_API_URL + "/" + userId);
